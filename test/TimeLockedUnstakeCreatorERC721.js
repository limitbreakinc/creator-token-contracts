...
const { shouldBehaveLikeCreatorToken, verifySuccessfulTimeLockedUnstake } = require('./CreatorToken.behavior');

const ONE_DAY = 1440 * 1;

describe("Time Locked Unstake Creator ERC-721 Tokens", function () {
  ...
  beforeEach(async function () {
    ...
    TimeLockedUnstakeCreatorERC721Mock = await ethers.getContractFactory("TimeLockedUnstakeCreatorERC721Mock");
  });

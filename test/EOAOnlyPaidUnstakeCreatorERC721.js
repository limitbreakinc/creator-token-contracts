...
const { shouldBehaveLikeCreatorToken, verifySuccessfulPaidUnstake } = require('./EOAOnlyCreatorToken.behavior');

describe("EOA Only Paid Unstake Creator ERC-721 Tokens", function () {
  ...
  beforeEach(async function () {
    ...
    PaidUnstakeCreatorERC721Mock = await ethers.getContractFactory("EOAOnlyPaidUnstakeCreatorERC721Mock");
  });

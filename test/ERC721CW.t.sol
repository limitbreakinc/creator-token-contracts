...
abstract contract ERC721CWTestBase {
    
}

contract ERC721CWTest is CreatorTokenTransferValidatorERC721Test, ERC721CWTestBase {
...
contract ERC721CWInitializableTest is CreatorTokenTransferValidatorERC721Test, ERC721CWTestBase {
    ...
    function setUp() public virtual override {
        ...
        tokenMock = ERC721CWInitializableMock(cloner.cloneContract(address(referenceTokenMock), address(this), initializationSelectors, initializationArguments));
    ...
    function _deployNewToken(address creator) internal virtual override returns (ITestCreatorToken) {
        ...
        ITestCreatorToken token = ITestCreatorToken(cloner.cloneContract(address(referenceTokenMock), creator, initializationSelectors, initializationArguments));
        vm.stopPrank();
        return token;
    }

...
const { shouldBehaveLikeCreatorToken } = require('./EOAOnlyCreatorToken.behavior');

describe("EOA Only Permanent Creator ERC-721 Tokens", function () {
  ...
  beforeEach(async function () {
    ...
    PermanentCreatorERC721Mock = await ethers.getContractFactory("EOAOnlyPermanentCreatorERC721Mock");
  });
